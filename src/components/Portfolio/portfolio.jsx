...
import one from "../../assets/uifaces-popular-image-1.jpg";
import two from "../../assets/uifaces-popular-image-2.jpg";
import three from "../../assets/uifaces-popular-image-3.jpg";
import four from "../../assets/uifaces-human-image-4.jpg";
import five from "../../assets/uifaces-human-image-5.jpg";
import six from "../../assets/uifaces-human-image-6.jpg";
...
export default function Portfolio() {
  ...
  return (
    <div className="h-full relative">
      <div className="text mx-auto mybg min-h-screen flex flex-col items-center p-4 sm:p-6 md:p-10">
        ...
        <div className="flex flex-wrap justify-center mt-4 sm:mt-6 md:mt-10 overflow-hidden">
          <div className="p-2 w-full sm:w-1/2 md:w-1/3">
            <div className="rounded-3xl relative group" data-aos="fade-left">
              <img
                src={one}
                alt="Portfolio Item"
                className="w-full h-auto rounded-3xl"
              />
              <div className="rounded-3xl w-full layout bg-black group-hover:opacity-40 opacity-0 group-hover:bg-slate-200 absolute top-0 left-0 bottom-0 right-0">
                <div class="loader z-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
                  <span class="l">
                    <svg
          ...
          <div className="p-2 w-full sm:w-1/2 md:w-1/3">
            <div className="rounded-3xl relative group" data-aos="fade-up">
              <img
                src={five}
                alt="Portfolio Item"
                className="w-full h-auto rounded-3xl"
          ...
          <div className="p-2 w-full sm:w-1/2 md:w-1/3">
            <div className="rounded-3xl relative group" data-aos="fade-right">
              <img
                src={six}
                alt="Portfolio Item"
                className="w-full h-auto rounded-3xl"
