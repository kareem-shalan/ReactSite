    ...
    <div>
      <footer className="bg-gray-900 px-4 sm:px-6   pt-16 pb-6 font-[sans-serif]">
        ...
        >
          ...
          <div className="space-y-4 min-[320px]:col-span-3 min-[320px]:flex min-[320px]:justify-center min-[320px]:items-center min-[320px]:flex-col xl:col-span-1">
